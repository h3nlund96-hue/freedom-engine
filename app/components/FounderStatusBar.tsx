...
export function FounderStatusBar() {
  return (
    <div className="relative z-10 w-full">
      <div className="absolute inset-0 bg-[rgba(10,7,4,0.80)] backdrop-blur-sm" />
      <div
        className="absolute inset-x-0 bottom-0 h-px"
        style={{
          background:
            "linear-gradient(to right, transparent, rgba(212,165,116,0.20) 25%, rgba(212,165,116,0.12) 75%, transparent)",
        }}
        aria-hidden
      />
      ...
      <div className="relative hidden items-center gap-6 px-8 py-2.5 sm:flex">
        ...
        >
          <div className="relative flex size-7 items-center justify-center rounded-md transition-all duration-300 group-hover:shadow-[0_0_12px_rgba(212,165,116,0.15)]">
            <div className="absolute inset-0 rounded-md bg-linear-to-br from-[rgba(212,165,116,0.16)] to-[rgba(232,132,42,0.07)]" />
            <div
              className="pointer-events-none absolute inset-0 rounded-md"
              style={{ boxShadow: "inset 0 1px 0 rgba(212,165,116,0.20), inset 0 0 0 1px rgba(212,165,116,0.10)" }}
              aria-hidden
            />
        ...
        <div className="flex w-72 flex-col gap-1.5 xl:w-96">
          <div
            ...
            style={{ background: "rgba(212,165,116,0.09)" }}
            role="progressbar"
          ...
          >
            <div
              ...
              style={{
                width: `${barPercent}%`,
                background: "linear-gradient(to right, rgba(212,165,116,0.65), rgba(232,132,42,0.82))",
                boxShadow: "0 0 6px rgba(232,132,42,0.30)",
              }}
            />
          </div>
      ...
      <div className="relative flex flex-col gap-1.5 px-5 py-2.5 sm:hidden">
        ...
        <div className="flex items-center gap-3">
          <Link href="/profile" aria-label="Founder Profile" className="group relative flex size-6 shrink-0 items-center justify-center rounded-md">
            <div className="absolute inset-0 rounded-md bg-linear-to-br from-[rgba(212,165,116,0.14)] to-[rgba(232,132,42,0.06)]" />
            <div
              className="pointer-events-none absolute inset-0 rounded-md"
              style={{ boxShadow: "inset 0 1px 0 rgba(212,165,116,0.18), inset 0 0 0 1px rgba(212,165,116,0.09)" }}
              aria-hidden
            />
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div
              ...
              style={{
                width: `${barPercent}%`,
                background: "linear-gradient(to right, rgba(212,165,116,0.60), rgba(232,132,42,0.78))",
                boxShadow: "0 0 5px rgba(232,132,42,0.25)",
              }}
            />
          </div>
